  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center relative">
      ...
      <div
        ...
        style={{
          transform: 'translate(-50%, -50%) rotate(-1.96deg)',
        }}
      >
      ...
      <div className="absolute bottom-[97px] left-1/2 -translate-x-1/2 w-[370px] h-[44px] font-black text-4xl leading-none tracking-normal text-center capitalize text-white flex items-center justify-center">
